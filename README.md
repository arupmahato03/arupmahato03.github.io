...
**Backend Development Engineer** — Togethring Media Labs · *Dec 2024 – Present*
- Designed and delivered 10+ Spring Boot microservices, decomposing a monolithic codebase for independent, faster deployments
...
**Languages:**
Java 8/11/17 · SQL · Core Java · OOP · Collections · Multithreading · Exception Handling

**Frameworks:**
Spring Boot · Spring MVC · Spring Data JPA · Spring Security · Spring AOP · Hibernate

**Architecture:**
Microservices · RESTful API Design · MVC · Layered Architecture · SOLID Principles · Monolith-to-Microservices Migration

**Databases:**
MySQL · MongoDB · Redis · Query Optimization · Indexing · Schema Design · Transaction Management

**Security:**
JWT · OAuth 2.0 · RBAC · Spring Security · API Authentication

**Tools & DevOps:**
Git · GitHub · Maven · Docker · Postman · Swagger/OpenAPI · IntelliJ IDEA · Linux · CI/CD · Agile/Scrum

**Integrations:**
Payment Gateways · Third-Party REST APIs · Webhooks · CRM Systems · Wix Plugin Services

---

## 📫 Connect

- **Email:** arup71062@gmail.com
